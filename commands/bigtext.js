...
module.exports.run = async (client, message, args) => {
  ...
  .addField(`:book: **|** Exemplo`, `\`${c.prefix}bigtext Asukie\``, true)
  ...
  .setFooter(`Requisitado: ${message.author.username}`, message.author.displayAvatarURL({dynamic: true}));
    ...
    try {
        ...
        return message.channel.send(`<a:errado:753245066965024871> | Então... Infelizmente, não consegui criar. Houve algum erro!`)
    }
